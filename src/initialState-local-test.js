    ...
    timeline:[
        {
            'id':'1',
            'serial':'TOOR9111',
            'deviceName': 'duster ZXY999',
            'typeEvent': 2,
            'messageEvent': 'salio de geocerca',
            'hora': '10:30 PM'
        },
        {
            'id':'4',
        ...
        },
        {
            ...
            'deviceName': 'duster ZXY999',
            'typeEvent': 2,
            'messageEvent': 'esta en movimiento',
            'hora': '10:50 PM'
        },
        {
            'id':'2',
            'serial':'DOYYOO99',
            'deviceName': 'moto mensajero',
            'typeEvent': 1,
            'messageEvent': 'Dispositivo agregado a tu cuenta',
            'hora': '11:00 PM',
        },
        {
            'id':'5',
            ...
            'deviceName': 'moto mensajero',
            'typeEvent': 3,
            'messageEvent': 'Dispositivo fuera de señal',
            'hora': '11:00 PM',
        }
    ]
}